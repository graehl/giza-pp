...
#define SMOOTH_USE_WB_CUTOFF 0
#define SMOOTH_KN_CHANGE_BACKWARD_LAYER 0
Node*
LM::
...
LM::
setKNcounts(bool
#if SMOOTH_KN_CHANGE_BACKWARD_LAYER
            isBackWard
#endif
            )
{
...
void
LM::
wbEstimate(bool interpolate, double*
#if SMOOTH_USE_WB_CUTOFF
           cutoff
#endif
           ){
#if SMOOTH_USE_WB_CUTOFF
